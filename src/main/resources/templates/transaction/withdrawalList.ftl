            ...
            <fieldset>
                ...
                <form class="layui-form layui-form-pane form-search" lay-filter="searchForm" autocomplete="off">
                    <div class="layui-form-item layui-inline" style="margin-right: 10px">
                        <button class="layui-btn layui-btn-sm layui-btn-danger" id="agree">批量通过</button>
                        <button class="layui-btn layui-btn-sm layui-btn-warning" id="refuse">批量拒绝</button>
                    </div>
