layui.use(['table', 'form', 'laydate'], function () {
	...
	table.render(
		Object.assign({}, $.tableRenderConfing, {
			elem: '#member-list',
	...
	table.on('tool(member-list)', function (obj) {
		...
		} else if (layEvent === 'accountChange') {
			// 帐变
			window.parent.layui.tab.tabAdd({
				id: 'caiwu_' + data.id,
				title: '帐变',
